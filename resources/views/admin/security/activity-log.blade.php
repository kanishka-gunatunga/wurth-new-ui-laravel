    ...
    <div class="row d-flex justify-content-between">
        ...
        <div class="col-lg-6 col-12 d-flex justify-content-lg-end gap-3 ">
            <div id="search-box-wrapper" class="collapsed">
                ...
                <input type="text" class="search-input" placeholder="Search ADM Number, User Name, Activity Type" />
            </div>
...
<div class="offcanvas offcanvas-end offcanvas-filter" tabindex="-1" id="searchByFilter"
    ...
    <div class="offcanvas-body">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                const activitySearchInput = document.querySelector("#search-box-wrapper .search-input");

                activitySearchInput.addEventListener("input", function() {
                    const query = this.value.toLowerCase();

                    // Filter the activityLogData
                    ...
                    renderFilteredActivityLogTable(filteredData);
                });
            });

            // Function to render filtered activity logs
            function renderFilteredActivityLogTable(data) {
                const tableBody = document.getElementById("activityLogTableBody");
                tableBody.innerHTML = "";
