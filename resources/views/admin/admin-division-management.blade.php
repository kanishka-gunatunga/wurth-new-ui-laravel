        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                searchInput.addEventListener("input", function() {
                    ...
                    // Filter division data based on divisionName or head
                    const filteredData = divisionManagementData.filter(division =>
                        division.divisionName.toLowerCase().includes(query) ||
                        division.head.toLowerCase().includes(query)
                    );
                ...
                function renderFilteredTable(data) {
                    ...
                    // Reset pagination to page 1 for filtered results
                    currentPage = 1;
                ...
                function renderFilteredPagination(data) {
                    ...
                    // Prev button
                    pagination.innerHTML += `<li class="page-item ${currentPage === 1 ? "disabled" : ""}">
                <a class="page-link" href="#" onclick="changeFilteredPage(${currentPage - 1}, data)">Prev</a>
            </li>`;

                    // Page numbers
                    for (let i = 1; i <= totalPages; i++) {
                        pagination.innerHTML += `<li class="page-item ${i === currentPage ? "active" : ""}">
                    <a class="page-link" href="#" onclick="changeFilteredPage(${i}, data)">${i}</a>
                </li>`;
                    }

                    // Next button
                    pagination.innerHTML += `<li class="page-item ${currentPage === totalPages ? "disabled" : ""}">
                <a class="page-link" href="#" onclick="changeFilteredPage(${currentPage + 1}, data)">Next</a>
            </li>`;
                }

                window.changeFilteredPage = function(page, data) {
                    const totalPages = Math.ceil(data.length / rowsPerPage);
                    if (page < 1 || page > totalPages) return;
