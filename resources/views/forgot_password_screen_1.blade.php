        ...
        <div class="card login-card d-flex align-items-center">
            <div class="card-body">
                <div class="row">
                    ...
                    <div>
                        <form action="https://loops-it.github.io/wurth-lanka/forgot_password_screen_2.html">
                            <p class="login-title text-center">PASSWORD RESET</p>
                            
                            <div class="my-5 input-div">
                                <img src="public/images/Email.png" alt="" class="input-icon envelop">
                                <input type="email" class="form-control login-input " id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter The Email to Get Password Reset Link">
                            </div>
