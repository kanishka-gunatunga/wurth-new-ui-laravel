...
<div class="main-wrapper">
                        ...
                        <ul class="dropdown-menu w-100 p-2" aria-labelledby="invoiceDropdownSearch"
                            ...
                            <table class="table table-sm mb-0">
                                ...
                                <tbody id="invoiceDropdownOptions">
                                    <tr>
                                        <td><input type="checkbox" class="me-2">Dimo Lanka - Colombo 01</td>
                                        <td>15864232114644</td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" class="me-2">Dimo Lanka - Nugegoda</td>
                                        <td>15864232114644</td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" class="me-2">Dimo Lanka - Homagama</td>
                                        <td>15864232114644</td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" class="me-2">Dimo Lanka - Galle</td>
                                        <td>15864232114644</td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" class="me-2">Dimo Lanka - Navinna</td>
                                        <td>15864232114644</td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" class="me-2">Dimo Lanka - Piliyandala</td>
                                        <td>15864232114644</td>
                                    </tr>
                                    <tr>
                                        <td><input type="checkbox" class="me-2">Dimo Lanka - Kelaniya</td>
                                        <td>15864232114644</td>
                                    </tr>
                                </tbody>
                            </table>
    ...
    <div class="styled-tab-sub p-4 mt-5" style="border-radius: 8px;">
        ...
        <div class="w-100">
            <p class="mb-2 red-bold-text">Final Set-off amount : Rs. 235,000.00</p>
...
<script>
    ...
    // Dummy array for Table 2
    const table2Data = [{
            fullName: "36583622211",
            invoiceNumber: "Rs.245,000"
        },
        {
            fullName: "36583622211",
    ...
    // Function to populate a table from an array
    function populateTable(tableId, data) {
        ...
        data.forEach((item, index) => {
            ...
            // Create the Full Name cell with checkbox
            const tdName = document.createElement("td");
            const checkbox = document.createElement("input");
            checkbox.type = "checkbox";
            checkbox.id = `${tableId}-item${index + 1}`;
            checkbox.checked = item.checked;

            const span = document.createElement("span");
            span.classList.add("ms-2");
            span.textContent = item.fullName;

            tdName.appendChild(checkbox);
            tdName.appendChild(span);

            // Create the Invoice Number cell
